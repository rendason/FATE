...
from federatedml.framework2.hetero.procedure import convergence
from federatedml.framework2.hetero.procedure import paillier_cipher, batch_generator
from federatedml.linear_model2.linear_model_weight import LinearModelWeights
from federatedml.linear_model2.logistic_regression.hetero_logistic_regression.hetero_lr_base import HeteroLRBase
from federatedml.optim2 import activation
from federatedml.optim2.gradient import hetero_lr_gradient_and_loss
        ...
        while self.n_iter_ < self.max_iter:
            ...
            for batch_data in batch_data_generator:
                ...
                if total_gradient is None:
                    total_gradient = optim_guest_gradient
                else:
                    total_gradient = total_gradient + optim_guest_gradient
                ...
                loss_list = self.gradient_loss_operator.compute_loss(data_instances,
                                                                     self.encrypted_calculator,
                                                                     self.n_iter_,
                                                                     batch_index,
                                                                     loss_norm)
